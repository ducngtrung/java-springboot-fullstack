            ...
            switch (sortOption) {
                case 1: { // Sắp xếp theo fullName, nếu giống fullName thì ai nhiều tuổi hơn xếp trước.
                    ...
                    for (int i = 0; i < studentList.size()-1; ++i) {
                        if ( (studentList.get(i).fullName.equalsIgnoreCase(studentList.get(i+1).fullName))
                            && (studentList.get(i).age < studentList.get(i+1).age) ) {
                ...
                case 2: { // Sắp xếp theo tuổi tăng dần, nếu bằng tuổi thì xếp theo GPA giảm dần.
                    ...
                    for (int i = 0; i < studentList.size()-1; ++i) {
                        if ( (studentList.get(i).age == studentList.get(i+1).age)
                            && (studentList.get(i).GPA < studentList.get(i+1).GPA) ) {
                                Student temp = studentList.get(i);
                                studentList.set(i, studentList.get(i+1));
                                studentList.set(i+1, temp);
                        }
