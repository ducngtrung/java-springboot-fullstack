...
public class FileService {
    ...
    public String uploadFile(int id, MultipartFile file) {
        ...
        // Tạo target file
        String fileId = String.valueOf(Instant.now().getEpochSecond()); // phương thức getEpochSecond() của đối tượng Instant trả về số giây tính từ ngày 01.01.1970 đến thời điểm hiện tại, dùng chính thông tin này gán cho fileId để biết file được upload vào thời điểm nào
